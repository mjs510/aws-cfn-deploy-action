...
array=(aws cloudformation deploy --stack-name $AWS_STACK_NAME --template-file $TEMPLATE $PARAMETER_FILE $CAPABILITIES $ROLE_ARN $FORCE_UPLOAD --no-fail-on-empty-changeset)
eval $(echo ${array[@]})
